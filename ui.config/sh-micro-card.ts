export default {
  ...
  teaser: {
    ...
    title: "title text-center text-2xl font-extrabold dark:saturate-[300%] break-words z-20 transition-transform duration-500 ease-in-out group-hover:translate-y-[-2rem] transform",
    ...
    text: "text text-center text-[1.1rem] opacity-0 group-hover:opacity-100 transition-opacity duration-500 ease-in-out font-light mt-2 mb-5 break-words z-20",
  },
  translate: {
