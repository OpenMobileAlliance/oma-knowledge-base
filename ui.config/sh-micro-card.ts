export default {
  ...
  teaser: {
    ...
    title: "title text-center text-2xl font-medium text-black dark:text-white break-words z-20 transition-transform duration-500 ease-in-out group-hover:translate-y-[-2rem] transform",
    subtitle: "subtitle text-center opacity-0 group-hover:opacity-100 transition-opacity duration-500 ease-in-out text-[1.3rem] font-thin dark:font-thin text-neutral-500 dark:text-gray-400 mt-1 break-words z-20 transition-transform group-hover:translate-y-[-1.1rem] transform",
    text: "text text-center opacity-0 group-hover:opacity-100 transition-opacity duration-500 ease-in-out font-light text-[1.1rem] mt-2 mb-5 break-words z-20",
  },
  translate: {
