...
A hybrid plenary session bringing together highlights from both tracks — sharing achievements, roadmap direction, and opportunities for broader community participation. [^1]
...
---
ui:
  wrapper: "not-prose bg-oma-cyan-300 dark: bg-oma-cyan-300 text-white text-base mr-4"
---
Track 1 — Interop Lab
:::
...
---
ui:
  wrapper: "not-prose bg-oma-yellow-300 dark:bg-oma-yellow-300 text-white text-base mx-4"
---
...
---
ui:
  wrapper: "not-prose bg-oma-blue-300 dark: bg-oma-blue-300 text-white text-base ml-4"
---
Plenary
:::
...
---
ui:
  wrapper: border bg-oma-blue-50 text-white mt-4 p-2 w-3/5
cols: 3
---
:::ShSegment
---
...
---
ui:
  wrapper: "text-stone-200 w-full text-right text-xs"
---
16:00
---
:::
...
---
ui:
  wrapper: "col-span-4 rounded-xl border shadow-md p-2 bg-oma-purple-50 dark: bg-oma-purple-50"
---
...
---
ui:
  wrapper: "col-span-4 rounded-xl border shadow-md p-4 bg-oma-purple-50 dark: bg-oma-purple-50"
---
...
[1] Session times are approximate. Actual timing may shift depending on session flow on the day.